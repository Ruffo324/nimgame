...
namespace console_handler
{
  ...
  {
  private:
    static int current_console_font_height_;
    static int current_console_font_width_;
  public:
    // get functions
    ...
    static void set_console_window_size(int height, int width);
    static void set_console_buffer_size(int height, int width);
    static void set_console_buffer_to_window_size();

    static void set_console_raster_font(int height, int width);
